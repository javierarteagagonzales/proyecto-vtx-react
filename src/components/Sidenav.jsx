    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <DrawerHeader>
        ...
        <List>
            ...
            <ListItem disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/area1")}} >
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
            ...
            <ListItem disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/area3")}}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
            ...
            <ListItem disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/area4")}}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
            ...
            <ListItem disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/acabados")}}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
            ...
            <ListItem disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/area6")}}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
            ...
            <ListItem disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/area7")}}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
